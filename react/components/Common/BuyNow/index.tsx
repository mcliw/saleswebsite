...
const BuyNow = () => {
  return (
    <button className="py-[12px] flex items-center justify-center gap-2 text-center w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-lg font-semibold transition-all duration-200 hover:from-blue-700 hover:to-blue-600 hover:shadow-md active:scale-95">
      <svg
